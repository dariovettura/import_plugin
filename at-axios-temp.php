						...
						<div class="col-lg-12">
							...
							<div class="row variable-gutters">
								...
								foreach (dsi_amministrazione_trasparente_array() as $inner) {
									$atcontatore++;
									$nice_link = sanitize_title($inner[0]);
									$atreturn = '<ul>';
									$atcounter = 0;
									...
									foreach ($inner[1] as $value) {
										...
										foreach ($json_array as $item) {
											if (!empty($json_array) && $item['category'] == $value) { 
												$atcounter++;
												$atfound = true;
											}
										}
										...
										$atct += $atcounter;
										$nice_link_child = sanitize_title($value);
										...
										$atreturn .= '<li ' . $opty . '>';
										$atreturn .= '<a href="' . home_url('/amministrazione-trasparente/axios/') . $nice_link_child . '/" title="' . $value . '">' . $value . '</a>';
										$atreturn .= '</li>';
									...
									echo '<span id="' . $sez_l . '" href="#' . $sez_l . '"><a href="' . home_url('/amministrazione-trasparente/axios/') . $nice_link . '/">' . $inner[0] . '</a></span></h3>';
